...
class SklearnTrainer:
    ...
    def __init__(self):
        ...
        self.sklearn_models = {
            ...
            "clustering": {"kmeans": KMeans, "dbscan": DBSCAN},
        }
...
class DataProcessor:
    ...
    @staticmethod
    def prepare_data(
        data_info: Dict[str, Any], target_column: str, feature_columns: Optional[List[str]] = None
    ) -> Dict[str, Any]:
...
def train_ml_model(
    ...
    try:
        ...
        prep_result = data_processor.prepare_data(data_result, target_column, feature_columns)
        ...
        print(
            f"Data prepared: {prep_result['data_info']['samples']} samples, {prep_result['data_info']['features']} features"
        )
...
TOOLS = [
    {
        ...
        "parameters": {
            ...
            "target_column": {
                "type": "str",
                "required": True,
                "description": "Name of target/label column",
            },
            "model_config": {
                "type": "dict",
                "required": False,
                "description": "Model configuration (model_type, algorithm, test_size, etc.)",
            },
            "feature_columns": {
                "type": "list",
                "required": False,
                "description": "List of feature column names (uses all non-target columns if not specified)",
            },
            "save_model": {
                "type": "str",
                "required": False,
                "description": "Name to save trained model",
            },
        },
        "category": "ml",
    },
    {
        ...
        "parameters": {
            "model_name": {
                "type": "str",
                "required": True,
                "description": "Name of saved model to use for predictions",
            },
            "features": {
                "type": "list",
                "required": True,
                "description": "List of feature vectors (each vector is a list of numbers)",
            },
        },
        "category": "ml",
    },
