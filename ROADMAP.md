...
- The repo still has documentation drift, root-level clutter, and an unfinished Windows application story
...
- identify legacy or duplicated GUI paths and formally label them as primary, secondary, or deprecated
...
- choose the official desktop shell and deprecate redundant GUI paths only after verification
...
- the repository has multiple GUI entry points without a formally declared primary desktop shell
