...
def list_directory(path: str = ".") -> str:
    ...
    try:
        ...
        def _build_tree(directory: Path, prefix: str = "", max_depth: int = 3, current_depth: int = 0) -> list:
                ...
                for i, entry in enumerate(entries):
                    ...
                    if entry.is_dir():
                        ...
                        if current_depth < max_depth - 1:
                            ...
                            items.extend(_build_tree(entry, next_prefix, max_depth, current_depth + 1))
                    else:
...
def register_secure_core_tools():
    ...
    registry.register_tool(
        ...
        handler=read_file, category="files",
        parameters={
    ...
    registry.register_tool(
        ...
        handler=write_file, category="files",
        parameters={
    ...
    registry.register_tool(
        ...
        handler=edit_file, category="files",
        parameters={
    ...
    registry.register_tool(
        name="Bash", description="Execute a shell command with security controls.",
        handler=run_bash, category="system",
        parameters={
    ...
    registry.register_tool(
        ...
        handler=glob_files, category="search",
        parameters={
    ...
    registry.register_tool(
        ...
        handler=grep_files, category="search",
        parameters={
    ...
    registry.register_tool(
        ...
        handler=list_directory, category="files",
        parameters={
